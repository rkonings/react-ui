...
import { User, ValidationErrors, OnChangeHandler } from './../Settings';
      ...
      <Section>
        ...
        <SettingsField
          ...
          input={
            <Checkbox
              onChange={(value) =>
                onChange([{ field: 'settings.pushNotifications', value }])
              }
        ...
        <SettingsField
          ...
          input={
            <Switch
              ...
              onChange={value =>
                onChange([{ field: 'settings.unscribeEmailLink', value }])
              }
            />
          }
        />
